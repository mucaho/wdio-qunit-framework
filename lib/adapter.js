...
class QUnitAdapter {
    constructor (cid, config, specs, capabilities) {
        // additional indirection for testing
        this.construct(cid, config, specs, capabilities)
    }

    construct (cid, config, specs, capabilities) {
        this.cid = cid
...
const adapterFactory = {
    run: async (cid, config, specs, capabilities) => {
        const adapter = new QUnitAdapter(cid, config, specs, capabilities)
